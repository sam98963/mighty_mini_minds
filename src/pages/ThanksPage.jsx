...
//     console.log(entryId);
//     setTimeout(() => {
//     // history.push("../moodMap");
    
//       // Perform the navigation by updating the NavLink's "to" prop
//       // Replace "/path" with the desired path for navigation
//       // window.location.href = "./appLayout/moodMap";
...
//         {share === null ? ( 
//         <h2 className="text-xl sm:text-2xl text-center px-4">Would you like to share your thoughts with someone?</h2> ):(null)}
//         {share === null ? (null):share ? ( <h2 className="text-xl sm:text-2xl text-center px-4">
//           {"Thanks for sharing your entry! It's on it's way to your trusted person!"}
//         </h2> ):(<h2>"Remember you can share your thoughts any time!"</h2>)}
  ...
  return (
    <div className="flex flex-col justify-around items-center w-full h-full overflow-hidden">
      ...
      {share === null ? null : share ? (
        ...
        <h2>"Remember you can share your thoughts any time!"</h2>
      )}
      <div className="flex flex-row justify-around items-center w-full">
        <button onClick={handleClick} value={false} className="text-white shadow-md text-4xl transition-colors duration-300 ease-in-out transform hover:scale-125 bg-skin-secondary rounded-md py-3 px-5">✕</button>
        <button onClick={handleClick} value={true} className="text-white shadow-md text-4xl transition-colors duration-300 ease-in-out transform hover:scale-125 bg-skin-secondary rounded-md py-3 px-5">✓</button>
