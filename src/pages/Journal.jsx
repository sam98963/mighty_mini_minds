...
const filteredEntries = entries?.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
    ...
    return (
        <div className=" h-full w-full overflow-y-scroll bg-red ">
            ...
            <label className="font-bold sm:text-base">Search by</label>
              <select className="bg-skin-input text-xs sm:text-base mx-4 p-2 rounded-lg shadow-md outline-none" defaultValue="All">
