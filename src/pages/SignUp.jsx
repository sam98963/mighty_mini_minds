...
export default function SignUp() {
  ...
  function handleSubmit(event){
    ...
    if(signupData.user !== "" && signupData.username !== "" && signupData.password !== "" && signupData.email !== "" && signupData.contactName !== "" && signupData.relationship !== ""){
      ...
      <div className="w-11/12 sm:w-9/12 lg:w-8/12 xl:w-7/12 mt-4 bg-white rounded-lg shadow-lg">
        ...
        <form className="flex flex-col mx-8 mt-4" onSubmit={handleSubmit}>
          <div className="flex flex-col mb-4">
            ...
            {/* input user */}
            <input className="bg-skin-input shadow-md" name="user" value={signupData.user} onChange={handleInputChange}/>
          </div>

          <div className="flex justify-between mb-4">
            <div className="flex flex-col w-1/2 mr-2">
              <label className="text-sm sm:text-base">Username</label>
              <input className="bg-skin-input shadow-md" name="username" value={signupData.username} onChange={handleInputChange}/>
            </div>
            <div className="flex flex-col w-1/2 ml-2">
              <label className="text-sm sm:text-base">Password</label>
              <input className="bg-skin-input shadow-md" name="password" value={signupData.password} onChange={handleInputChange}/>
            </div>
          </div>

          <div className="flex flex-col mb-4">
            <label className="text-sm sm:text-base">Email of someone you trust*</label>
            <input className="bg-skin-input shadow-md" name="email" value={signupData.email} onChange={handleInputChange}/>
          </div>

          <div className="flex justify-between mb-4">
            <div className="flex flex-col w-1/2 mr-2">
              <label className="text-sm sm:text-base">Contact name</label>
              <input className="bg-skin-input shadow-md" name="contactName" value={signupData.contactName} onChange={handleInputChange}/>
            </div>
            <div className="flex flex-col w-1/2 ml-2">
              <label className="text-sm sm:text-base">Relationship</label>
              <input className="bg-skin-input shadow-md" name="relationship" value={signupData.relationship} onChange={handleInputChange}/>
            </div>
          </div>
          ...
          <div className="flex justify-between mb-4">
            <div className="flex flex-col mb-4 w-1/4 sm:w-1/3">
              ...
              <select className="bg-skin-input text-xs sm:text-base" name="avatar" value={signupData.avatar} onChange={handleInputChange}>
