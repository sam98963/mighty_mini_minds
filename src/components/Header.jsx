...
export default function Header() {
  ...
  return (
    <header className="flex justify-between h-28 items-center">
      ...
      <div onClick={handleProfileNavigation} className="cursor-pointer h-12 w-12 sm:h-20 sm:w-20 bg-skin-secondary rounded-full m-2 sm:m-10 flex items-center justify-center">
